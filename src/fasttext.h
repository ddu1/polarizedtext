...
/** Changes: 2016-9-20
 * Modified to include polarization along with negative sampling
 * Modifications are commeted
 * See post on ddu1.github.io
 *  Daping Du
 */
...
class FastText {
  ...
  public:
    ...
    // polarized word embedding 
    void pwv(Model&, real, const std::vector<int32_t>&); 
